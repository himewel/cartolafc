...
class Transformer2014(AbstractTransformer):
    def get_scouts(self):
        hdfs = self.get_conn()
        clubes_df = pd.read_csv(f"{hdfs}/raw/2014/times_ids/1.csv", dtype=str)
        ...
        scouts_df = pd.read_csv(f"{hdfs}/raw/2014/scouts_raw/1.csv", dtype=str)
    ...
    def get_partidas(self):
        ...
        partidas_df = pd.read_csv(f"{hdfs}/raw/2014/partidas_ids/1.csv", dtype=str)
    ...
    def get_atletas(self):
        hdfs = self.get_conn()
        atletas_df = pd.read_csv(f"{hdfs}/raw/2014/jogadores/1.csv", dtype=str)
